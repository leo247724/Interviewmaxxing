...
- **Runner** (additive): `preparation.ready` gains `steps`; `LocalApplicationRunner.submit`, `create_submission_runner`, `PREPARED_EVENT`, `MISMATCH_MESSAGE`, `NOT_AUTHORIZED_MESSAGE`, `ALLOW_SUBMISSION_ENV`.
