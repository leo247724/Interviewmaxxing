...
- **Cache.** The priority is part of `preferences.fingerprint`, so changing it invalidates earlier decisions. The rubric version is `jev-selection-rubric/2026-09-22.7`.
