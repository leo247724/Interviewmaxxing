...
COVER_LETTER_RULES = (
    ...
    "he has done. This paragraph brings in no other employer's work. In the whole letter any other "
    ...
    "40-employer test: it could not be sent to another employer. Name each employer once with one "
    "date where it first appears: the year the work happened ('in 2023') or 'since <Month YYYY>' "
    "for current work; never a date range ('from 2022 to 2023', 'March 2024 to May 2025'). Each "
