...
the Workable dropzone show an error alert instead of the file. Both hooks must be set
before the page script runs (an init script). Headless sessions of the runtime present a Linux user agent; a test can start a
